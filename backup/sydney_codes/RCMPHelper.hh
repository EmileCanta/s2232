...
// TODO: Replace all EXAMPLEEVENT and ExampleEvent with the name you want to use for this helper action
...
public:
   ...
   {
      Prefix("RCMP"); //This is where the name of the root file comes from!! (Ex. this one gives something like RCMP28205_000.root)
      Setup();
   }
