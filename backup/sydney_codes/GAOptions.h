...
struct GAOptions {
    ...
    // Directories
    static inline std::string const histogram_directory = "/home/sydney/S2232_analysis/Histograms/Alphanumeric";
    ...
    // Histogram prefixes
    static inline std::string const alphanumeric_prefix = "Alphanumeric";
    ...
    static inline int const matrix_dimension = 1024;
    static inline int const number_of_detectors = 64;
};
