...
{ 
	...
	G4Material* bc422q = new G4Material("BC422Q", density = 1.032*g/cm3, nComponents=2);
	bc422q->AddElement(elH, 51.9*perCent);
	bc422q->AddElement(elC, 48.1*perCent);
	myMaterials.push_back(bc422q);
	
	G4Material* ej228 = new G4Material("EJ228", density = 1.023*g/cm3, nComponents=2);
	ej228->AddElement(elH, 52.3337*perCent);
	ej228->AddElement(elC, 47.6663*perCent);
	myMaterials.push_back(ej228);
