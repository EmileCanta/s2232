...
public:
    ...
    G4double fPacesPlacementDistance[12];
    G4double fPacesPlacementTheta[12];
    G4double fPacesPlacementPhi[12];
    G4double fPacesOrientationTheta[12];
    G4double fPacesOrientationPhi[12];
